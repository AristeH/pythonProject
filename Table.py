...
def table(frame_parent, data):
    ft = Frame(frame_parent)
...
class TkSheetTable:
    def __init__(self, master, header, bindings):
        ...
        # self.sheet.grid(row=1, column=0, sticky="nswe", padx=10, pady=10)
        ...
        self.sheet.grid(row=1, column=0, sticky="nswe", padx=5, pady=5)
